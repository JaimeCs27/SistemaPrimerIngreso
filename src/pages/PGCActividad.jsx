        ...
        <div>
            ...
            <div className='min-h-screen bg-[#29364E] text-white'>
                <div className='p-10'>
                    ...
                    <div className='pb-5'>
                        <Link to={`/ProfesorGuiaCoordinador/PlanDeTrabajo/Editar/${id}`}>
                            <button class='py-1 px-4 bg-white text-[#061931] rounded-[10px] mx-2'>Modificar Actividad</button>
                        </Link>
                    </div>
...
export default GPGPlandeTrabajo