...
import Header from "../components/HeaderProfesorGuiaCoord"
import '../../styles.css'
            ...
            <div className='min-h-screen bg-[#29364E] text-white flex'>
                        ...
                        <div className='p-10 font=semibold rounded-xl shadow-lg ring-2 ring-[#081434] m-10 space-y-5'>
                            {loadingActivities ? (
                                        ...
                                        {activitiesList.map((activity) => (
                                            <div className='py-2'>
                                            <Link to={`/ProfesorGuiaCoordinador/PlanDeTrabajo/VerDetalles/${activity._id}`}>
                ...
                <div className='flex flex-col w-[50%]'>
                    ...
                    <div className='flex justify-end pr-[85px]'>
                        <Link to="/ProfesorGuiaCoordinador/PlanDeTrabajo/Crear">
