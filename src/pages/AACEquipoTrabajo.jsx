...
const AACartago = () => {
  ...
  const [coordSelection, setCoord] = useState("")
  ...
  const handleAssignCoord = () => {
    axios.post(`https://tecportfolio-api.onrender.com/AsistenteAdministrativo/AsignarCoordinador`, {
      coordSelection
    }).then((response) => {
        ...
        <div className="min-h-screen bg-[#29364E] text-white">
          <div className='flex'>
            ...
            <div className="flex w-1/2 p-4">
                      ...
                      {teamwork.map((prof) => (
                        <div className='flex items-center pl-5 pr-4 py-4 bg-[#061634] rounded-[16px] my-3'>
                          <div className="flex-shrink-0">
                            <input onChange={() => setCoord(prof._id)} type="radio" name="equipo" className="form-checkbox h-5 w-5 text-blue-600 rounded focus:ring-blue-500" />
                          </div>
                          <div className="flex-grow flex items-center justify-between ml-4">
                            ...
                            <div>
                            <Link to={`/AsistenteAdministrativoCartago/VerDetalles/${prof._id}`}>Ver Detalles</Link>
                            </div>
                          </div>
                        </div> 
                      ))}
              ...
              <div className='flex flex-col w-[calc(100%-757px)] p-4'>
                <div className="flex justify-end items-start flex-1 pt-[55px]">
                  <button onClick={handleAssignCoord} className="mx-2 bg-[#ffffff] text-[#061931] py-1 px-4 rounded-[10px]">
            ...
            <div className="flex w-1/2 p-4">
              <div className='w-[575px] p-4'>
                <h3 className="font-bold text-lg mb-4">Representante Sede Cartago</h3>
                <div div className="bg-[#29364E] rounded-[16px] w-[575px] mb-3 h-[400px] px-5 border-2 border-[#061634]">
                  ...
                  {loadingRepresentante ? (
                      ...
                      <div className="flex-grow flex items-center justify-between ml-4 my-1">
                        ...
                        <div>
                        <Link to={`/AsistenteAdministrativoCartago/VerDetalles/${representante._id}`}>Ver Detalles</Link>
                        </div>
                      </div>
                    </div>
                    )}
                    ...
                    <div className="custom-scrollbar bg-[#29364E] rounded-[16px] mb-3 overflow-auto h-[200px] pt-3 scrollbar-webkit scrollbar-thin"> {/* Scrollbar appears if content exceeds 24rem/96px */}
                      {loading ? (
                          ...
                          {profsList.map((prof) => (
                            <div className='flex items-center pl-5 pr-4 py-4 bg-[#061634] rounded-[16px] my-3'>
                              <div className="flex-shrink-0">
                                <input onClick={() => setSelect(prof._id)} type="radio" name="profes" className="form-checkbox h-5 w-5 text-blue-600 rounded focus:ring-blue-500" />
                              </div>
                              <div className="flex-grow flex items-center justify-between ml-4">
