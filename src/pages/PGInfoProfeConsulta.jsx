      ...
      <div className="min-h-screen bg-[#29364E] text-white">
          ...
          <div className="w-1/3 pt-7">
              {loading ? (
                ...
                <div>
                  <div className="pb-6">
                    <input type="input" class="p-2.5 w-full z-20 text-sm text-black bg-white rounded-[16px] focus:outline-none" value={name} disabled/>
                  </div>
                  <div className="pb-6">
                    <input type="input" class="p-2.5 w-full z-20 text-sm text-black bg-white rounded-[16px] focus:outline-none" value={lastName} disabled/>
                  </div>
                  <div className="pb-6">
                    <input type="input" class="p-2.5 w-full z-20 text-sm text-black bg-white rounded-[16px] focus:outline-none" value={email} disabled/>
                  </div>
                  <div className="pb-6">
                    <input type="input" class="p-2.5 w-full z-20 text-sm text-black bg-white rounded-[16px] focus:outline-none" value={officePhone} disabled/>
                  </div>
                </div>
              )}
          ...
          <div className="w-1/3 p-4 pt-7">
            {loading ? (
              ...
              <div>
                  <div className="pb-6">
                    <input type="input" class="p-2.5 w-full z-20 text-sm text-black bg-white rounded-[16px] focus:outline-none" value={secondName} disabled/>
                  </div>
                  <div className="pb-6">
                    <input type="input" class="p-2.5 w-full z-20 text-sm text-black bg-white rounded-[16px] focus:outline-none" value={secondLastName} disabled/>
                  </div>
                  <div className="pb-16">
                  </div>
                  <div className="">
                    <input type="input" class="p-2.5 w-full z-20 text-sm text-black bg-white rounded-[16px] focus:outline-none" value={phoneNumber} disabled/>
                  </div>
                </div>
            )}
...
export default GInfoProfeConsulta
